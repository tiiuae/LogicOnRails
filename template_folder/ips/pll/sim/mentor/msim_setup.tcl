...
# ----------------------------------------
# ACDS 22.4 94 linux 2023.10.11.12:00:52
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/fathimath/isoftware/quartus/intelFPGA_pro/22.4/quartus/"
}
...
alias file_copy {
  ...
  set normalized_src [pll::normalize_path "$file"]
  set normalized_dest [pll::normalize_path "$dest_file"]
